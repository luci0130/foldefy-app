    ...
    vec![
        FolderTemplate {
            ...
            structure: vec![
                TemplateFolderNode {
                    ...
                    children: vec![TemplateFolderNode {
                        name: "{{project_name}}".to_string(),
                        description: Some("Main project folder".to_string()),
                        children: vec![
                            TemplateFolderNode {
                                name: "src".to_string(),
                                description: None,
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Courses and tutorials".to_string()),
                    children: vec![
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Development tools and configs".to_string()),
                    children: vec![
                        TemplateFolderNode {
                            name: "Scripts".to_string(),
                            description: None,
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Completed or inactive projects".to_string()),
                    children: vec![],
                },
            ],
            personalization_questions: vec![PersonalizationQuestion {
                id: "q1".to_string(),
        ...
        FolderTemplate {
            ...
            structure: vec![
                TemplateFolderNode {
                    ...
                    description: Some("Client photo shoots".to_string()),
                    children: vec![TemplateFolderNode {
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Portfolio showcase".to_string()),
                    children: vec![
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Presets, textures, overlays".to_string()),
                    children: vec![
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    name: "Archive".to_string(),
                    description: Some("Past projects archive".to_string()),
                    children: vec![],
                },
            ],
            personalization_questions: vec![PersonalizationQuestion {
        ...
        FolderTemplate {
            ...
            structure: vec![
                TemplateFolderNode {
                    name: "Clients".to_string(),
                    description: Some("Client financial records".to_string()),
                    children: vec![TemplateFolderNode {
                ...
                TemplateFolderNode {
                    name: "Tax Season".to_string(),
                    description: Some("Annual tax filings".to_string()),
                    children: vec![
                        TemplateFolderNode {
                            name: "2024".to_string(),
                            description: None,
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Document templates".to_string()),
                    children: vec![
                        TemplateFolderNode {
                            name: "Invoice Templates".to_string(),
                            description: None,
                            children: vec![],
                        },
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    name: "Archive".to_string(),
                    description: Some("Completed fiscal years".to_string()),
                    children: vec![],
                },
            ],
            personalization_questions: vec![PersonalizationQuestion {
        ...
        FolderTemplate {
            ...
            structure: vec![
                TemplateFolderNode {
                    name: "Semesters".to_string(),
                    description: Some("Course materials by semester".to_string()),
                    children: vec![TemplateFolderNode {
                        name: "Current Semester".to_string(),
                        description: None,
                        children: vec![TemplateFolderNode {
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Research papers and projects".to_string()),
                    children: vec![
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    name: "Portfolio".to_string(),
                    description: Some("Best work showcase".to_string()),
                    children: vec![],
                },
                TemplateFolderNode {
                    name: "Archive".to_string(),
                    description: Some("Past semesters".to_string()),
                    children: vec![],
                },
            ],
            personalization_questions: vec![PersonalizationQuestion {
        ...
        FolderTemplate {
            ...
            structure: vec![
                TemplateFolderNode {
                    name: "Projects".to_string(),
                    description: Some("Design projects".to_string()),
                    children: vec![TemplateFolderNode {
                        name: "{{project_name}}".to_string(),
                        description: None,
                        children: vec![
                            TemplateFolderNode {
                                name: "Design Files".to_string(),
                                description: None,
                                children: vec![],
                            },
                            TemplateFolderNode {
                ...
                TemplateFolderNode {
                    name: "Brand Assets".to_string(),
                    description: Some("Logos, colors, typography".to_string()),
                    children: vec![
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Mood boards and references".to_string()),
                    children: vec![],
                },
                TemplateFolderNode {
                    name: "Templates".to_string(),
                    description: Some("Reusable design templates".to_string()),
                    children: vec![],
                },
                TemplateFolderNode {
                    name: "Archive".to_string(),
                    description: Some("Completed projects".to_string()),
                    children: vec![],
                },
            ],
            personalization_questions: vec![PersonalizationQuestion {
        ...
        FolderTemplate {
            ...
            structure: vec![
                TemplateFolderNode {
                    name: "Clients".to_string(),
                    description: Some("Client projects and contracts".to_string()),
                    children: vec![TemplateFolderNode {
                        name: "{{client_name}}".to_string(),
                        description: None,
                        children: vec![
                ...
                TemplateFolderNode {
                    ...
                    description: Some("Business administration".to_string()),
                    children: vec![
                        TemplateFolderNode {
                            name: "Finances".to_string(),
                            description: None,
                            children: vec![],
                        },
                        TemplateFolderNode {
                ...
                TemplateFolderNode {
                    name: "Portfolio".to_string(),
                    description: Some("Showcase work".to_string()),
                    children: vec![],
                },
                TemplateFolderNode {
                    name: "Resources".to_string(),
                    description: Some("Tools and templates".to_string()),
                    children: vec![],
                },
                TemplateFolderNode {
                    name: "Archive".to_string(),
